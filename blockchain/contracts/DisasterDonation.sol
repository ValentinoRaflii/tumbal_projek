    ...
    contract DisasterDonation {
        ...
        mapping(uint256 => mapping(address => bool)) public disbursementApprovals;
        ...
        function approveDisbursement(uint256 _disbursementId) external onlyAdmin {
            ...
            require(
            !disbursementApprovals[_disbursementId][msg.sender],
            "Already approved by this admin"
            );

            disbursementApprovals[_disbursementId][msg.sender] = true;
